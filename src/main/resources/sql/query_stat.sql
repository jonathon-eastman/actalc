SELECT CC, CO, PJT, TP, ACC, REPLACE(DTA, -99999999999999999999, 'Actual') FROM (SELECT 'Cost Center' as "CC", 'Company' as "CO", 'Project' as "PJT", 'Time Periods' as "TP", 'Accounts' as "ACC", -99999999999999999999 as "DTA" FROM DUAL
UNION ALL
...
FROM cloud_actadm
WHERE ( ((cloud_actadm.account like '953%') OR (cloud_actadm.account like '952%') OR (cloud_actadm.account like '951%') OR (statistic_amount <> 0)) )
