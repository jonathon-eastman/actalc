...
public class Def {
	...
	static {
		LINKS.put("/js/wh/h_" + CUBE_NAME.toLowerCase() + "_ar_17.txt", DIR_HISTORY);
		LINKS.put("/js/wh/h_" + CUBE_NAME.toLowerCase() + "_ar_16.txt", DIR_HISTORY);
		LINKS.put("/js/wh/h_" + CUBE_NAME.toLowerCase() + "_af48_18.txt", DIR_HISTORY);
		LINKS.put("/js/wh/h_" + CUBE_NAME.toLowerCase() + "_wp_18.txt", DIR_HISTORY);
		LINKS.put("/js/wh/h_" + CUBE_NAME.toLowerCase() + "_ar_18.txt", DIR_CPHISTORY);
	};
