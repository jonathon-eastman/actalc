...
public class RelationalDatabaseService {
	...
	public static void extractPSGLCurrentMonthBase() {
		...
		hypusr.queryBlocking(ServiceDefs.DIRECTORY_PROJECT + "_base_query_monetary.sql", ServiceDefs.DIRECTORY_PROJECT + "/data/" + ServiceDefs.DIRECTORY_BASE + "/act_monetary_ap" + ServiceDefs.CURRENT_PERIOD + "_" + ServiceDefs.CURRENT_YEAR + ".txt");
		hypusr.queryBlocking(ServiceDefs.DIRECTORY_PROJECT + "_base_query_stat.sql", ServiceDefs.DIRECTORY_PROJECT + "/data/" + ServiceDefs.DIRECTORY_BASE + "/act_statistical_ap" + ServiceDefs.CURRENT_PERIOD + "_" + ServiceDefs.CURRENT_YEAR + ".txt");
	...
	public void extractCurrentMonthIncremental() {
		...
		hypusr.queryBlocking(ServiceDefs.DIRECTORY_PROJECT + "_incr_query_monetary.sql", ServiceDefs.DIRECTORY_PROJECT + "/data/" + ServiceDefs.DIRECTORY_INCR  + "/act_monetary_ap" + ServiceDefs.CURRENT_PERIOD + "_" + ServiceDefs.CURRENT_YEAR + ".txt");
		hypusr.queryBlocking(ServiceDefs.DIRECTORY_PROJECT + "_incr_query_stat.sql", ServiceDefs.DIRECTORY_PROJECT + "/data/" + ServiceDefs.DIRECTORY_INCR + "/act_monetary_ap"+ ServiceDefs.CURRENT_PERIOD + "_" + ServiceDefs.CURRENT_YEAR +".txt");
