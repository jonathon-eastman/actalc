...
public class RelationalDatabaseService {
	...
	public static void extractPSGLCurrentMonth() {
		...
		hypusr.queryBlocking("query_monetary.sql", ServiceDefs.DIRECTORY_PROJECT + "/data/" + ServiceDefs.DIRECTORY_RELATIONAL + "/act_monetary_ap" + ServiceDefs.CURRENT_PERIOD + "_" + ServiceDefs.CURRENT_YEAR + ".txt");
		hypusr.queryBlocking("query_stat.sql", ServiceDefs.DIRECTORY_PROJECT + "/data/" + ServiceDefs.DIRECTORY_RELATIONAL + "/act_statistical_ap" + ServiceDefs.CURRENT_PERIOD + "_" + ServiceDefs.CURRENT_YEAR + ".txt");
